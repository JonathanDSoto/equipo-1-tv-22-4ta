    ...
    if (
        ...
        switch ($_POST['action']) {
            case 'create':
                ...
                $clientsController->CreateClient($name, $email, $password, $phone_number, $is_suscribed);
                break;
            case 'delete':
            ...
            case 'update':
                ...
                $id = strip_tags($_POST['client_id']);

                $clientsController = new ClientsController();
                $clientsController->EditClient($name, $email, $password, $phone_number, $is_suscribed, $level_id, $id);
                break;
        }
    }
}
class ClientsController {
    ...
    public function CreateClient($name, $email, $password, $phone_number, $is_suscribed) {
    ...
    public function EditClient($name, $email, $password, $phone_number, $is_suscribed, $level_id, $id) {
